...
/*=============================================================================
FUNCTION:  tavarua_vidioc_try_fmt_type_private
=============================================================================*/
/**
  This function is here to make the v4l2 framework happy.
  We can use fmt private type.

  @param file: File descriptor returned by open().
  @param f: pointer to struct v4l2_format.

  @return On success 1 is returned, else error code.
  @return EINVAL: The tuner index is out of bounds or the value in the type
  field is wrong.
*/
static int tavarua_vidioc_try_fmt_type_private(struct file *file, void *fh,
					  struct v4l2_format *f)
{
	return 1;
}
